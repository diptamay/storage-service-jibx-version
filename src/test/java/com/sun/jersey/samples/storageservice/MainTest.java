...
import com.sun.jersey.samples.storageservice.rs.jibx.JiBXBodyReader;
import com.sun.jersey.samples.storageservice.rs.jibx.JiBXBodyWriter;
import com.sun.jersey.samples.storageservice.types.Container;
import com.sun.jersey.samples.storageservice.types.Containers;
...
public class MainTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        cc.getClasses().add(JiBXBodyWriter.class);
        cc.getClasses().add(JiBXBodyReader.class);
    ...
    public void testContainersResource() {
        Containers containers = r.path("v1.0").path("containers").
    ...
    public void testPutOnContainerAndItemResource() {
        ...
        WebResource content = r.path("v1.0").path("containers").path("quotes");
